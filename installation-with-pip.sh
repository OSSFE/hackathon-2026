...
# cad-to-dagmc-mesher arrives as a dependency and would resolve to 0.3.0, which panics on
# this geometry with "orient_3d_sos: all projections degenerate", so it is held at 0.2.x
